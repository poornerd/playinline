package controllers.com.poornerd.playinline;
...
import controllers.com.poornerd.playinline.util.PropertiesChanger;
...
public class PlayInline extends Controller {
    ...
    static void saveMessages(String _key, String _newValue) {
        ...
        if (is == null) {
            is = PlayInline.class.getResourceAsStream("/" + MESSAGES_FILENAME);
        }
